...
export default function Invoices() {
    ...
    const [cfulladd,setCfulladd] = useState("")
    const [cbilladd,setCbilladd] = useState("")
    const [cinvoicedate,setCinvoicedate] = useState("")
    const [cduedate,setCduedate] = useState("")
    const [citem1,setCitem1] = useState("")
    const [citemdes1,setCitemdes1] = useState("")
    const [citemunit1,setCitemunit1] = useState("")
    const [citemqty1,setCitemqty1] = useState("")
    const [citem2,setCitem2] = useState("")
    const [citemdes2,setCitemdes2] = useState("")
    const [citemunit2,setCitemunit2] = useState("")
    const [citemqty2,setCitemqty2] = useState("")
    const [cdiscound,setCdiscound] = useState("")
    const [cotherinfo,setCotherinfo] = useState("")
    ...
    const sendData = async()=>{
        try{
            ...
            const data = await fetch("http://localhost:8000/api/user/invoice",{
                method:"post",
                headers:{
                    "Content-Type":"application/json",
                },
                body:JSON.stringify(invo)
            });
    ...
    const cinvoicedate1 = (e) =>{
        const value = e.target.value;
        setCinvoicedate(value)
    }
    ...
    const citemdes1first = (e) =>{
        const value = e.target.value;
        setCitemdes1(value)
    }

    const citemunit1first = (e) =>{
        const value = e.target.value;
        setCitemunit1(value)
        
    }

    const citemqty1first = (e) =>{
        const value = e.target.value;
        setCitemqty1(value)
    }
    ...
    const citemdes2sec = (e) =>{
        const value = e.target.value;
        setCitemdes2(value)
    }

    const citemunit2sec = (e) =>{
        const value = e.target.value;
        setCitemunit2(value)
    }

    const citemqty2sec = (e) =>{
        const value = e.target.value;
        setCitemqty2(value)
    }
            ...
            >
                ...
                {/* -------------------------- start 1 --------------------- */}
                                            ...
                                            <div className="row">
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <select className="select form-control" onChange={cname1} value={cname}>
                                                ...
                                                <div className="col-sm-12 col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <select className="select form-control" onChange={cdepart1} value={cdepart}>
                                                ...
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        <label>Email</label>
                                                        <input className="form-control" type="email" onChange={cemail1} value={cemail}/>
                                                    </div>
                                                </div>
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        <label>Tax</label>
                                                        <select className="select form-control" onChange={ctax1} value={ctax}>
                                                ...
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <textarea className="form-control" rows="3" onChange={cfulladd1} value={cfulladd}></textarea>
                                                    </div>
                                                </div>
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        <label>Billing Address</label>
                                                        <textarea className="form-control" rows="3" onChange={cbilladd1} value={cbilladd}></textarea>
                                                    </div>
                                                </div>
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="cal-icon">
                                                            <input className="form-control datetimepicker" type="text" onChange={cinvoicedate1} value={cinvoicedate}/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-sm-6 col-md-3">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="cal-icon">
                                                            <input className="form-control datetimepicker" type="text" onChange={cduedate1} value={cduedate}/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <table className="table table-hover table-white">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <input className="form-control" type="text" style={{ minwidth: "150px" }} onChange={citem1first} value={citem1}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" type="text" style={{ minwidth: "150px" }} onChange={citemdes1first} value={citemdes1}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" style={{ width: "100px" }} type="text" onChange={citemunit1first} value={citemunit1}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" style={{ width: "80px" }} type="text" onChange={citemqty1first} value={citemqty1}/>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td>
                                                                        <input className="form-control" type="text" style={{ minwidth: "150px" }} onChange={citem2sec} value={citem2}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" type="text" style={{ minwidth: "150px" }} onChange={citemdes2sec} value={citemdes2}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" style={{ width: "100px" }} type="text" onChange={citemunit2sec} value={citemunit2}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control" style={{ width: "80px" }} type="text" onChange={citemqty2sec} value={citemqty2}/>
                                                                    </td>
                                                                    <td>
                                                                        <input className="form-control form-amt" readonly="" style={{ width: "120px" }} type="text" />
                                                                    </td >
                                                        ...
                                                        <table className="table table-hover table-white">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style={{ textAlign: "right", paddingRight: "30px", width: "230px" }}>
                                                                        <input className="form-control text-right" type="text" onChange={cdiscound1} value={cdiscound}/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <div className="form-group">
                                                                ...
                                                                <textarea className="form-control" onChange={cotherinfo1} value={cotherinfo}></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="modal-footer">
                            ...
                            <button className="btn btn-success " onClick={sendData}>Save & Send</button>
